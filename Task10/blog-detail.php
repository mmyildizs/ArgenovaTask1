...
<html lang="en">
  ...
  <div class="contentCol1">
	   ...
	   <p class="bd-W5">Admin</p>
	   <p class="bd-W6">December 3, 2020 at 8:30 am</p>
	   <p class="bd-W7">Aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est</p>
	   ...
	   <form class="row g-3">
		  ...
		  <div class="col-md-6">
			<input type="text" class="form-control" id="inputName" placeholder="Ad*">
		  </div>
		  <div class="col-md-6">
			<input type="email" class="form-control" id="inputEmail" placeholder="Email*">
		  </div>
		  <div class="col-12">
			<textarea  style="resize:none" rows="5" class="form-control" id="inputComment" placeholder="Yorum"></textarea>
		  </div>
		  <a class="btnAS8" href="blog-detail.html">Yorumla</a>
	   </form>
